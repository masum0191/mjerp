...
<div id="sendMassege" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true" class="modal fade text-left">
    <div role="document" class="modal-dialog">
      <div class="modal-content">
        <form method="POST" action="{{ route('whatsapp.post') }}">
        {{ csrf_field() }}
        <div class="modal-header">
          <h5 id="exampleModalLabel" class="modal-title">Send Massege</h5>
          <button type="button" data-dismiss="modal" aria-label="Close" class="close"><span aria-hidden="true"><i class="dripicons-cross"></i></span></button>
        </div>
        <div class="modal-body">
            ...
            <div class="form-group">
                ...
                <input type="number" name="phone" step="any" class="form-control" required>
            </div>
            <div class="form-group">
                <label>Massege</label>
